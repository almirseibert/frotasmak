...
const parseEmployeeJsonFields = (employee) => {
    ...
    if (newEmployee.alocadoEm) newEmployee.alocadoEm = JSON.parse(newEmployee.alocadoEm);
    if (newEmployee.ultimaAlteracao) newEmployee.ultimaAlteracao = JSON.parse(newEmployee.ultimaAlteracao);
    return newEmployee;
};
